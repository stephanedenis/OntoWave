...
${e}
      ...
      `,o.textContent=e,document.getElementById("notification-styles")||((e=document.createElement("style")).id="notification-styles",e.textContent=`
        ...
        `,document.head.appendChild(e)),document.body.appendChild(o),setTimeout(()=>{o.style.animation="slideIn 0.3s ease reverse",setTimeout(()=>{o.parentNode&&o.parentNode.removeChild(o)},300)},3e3)}showError(e){var o=document.getElementById("ontowave-content");o&&(o.innerHTML=`<div class="ontowave-error">❌ ${e}</div>`)}toggleConfigurationPanel(t){t&&(t.preventDefault(),t.stopPropagation());t=document.querySelector(".ontowave-menu-content");if(t){var n=document.querySelector('.ontowave-menu-option[onclick*="toggleConfigurationPanel"]');let o=document.getElementById("ontowave-config-panel");if(o){o.remove(),n&&n.classList.remove("selected");let e=document.getElementById("ontowave-floating-menu");e&&e.classList.remove("has-config-panel"),"function"==typeof c.ontowaveUpdateDragState&&c.ontowaveUpdateDragState(),void console.log("Config panel closed")}else{n&&n.classList.add("selected"),(o=document.createElement("div")).id="ontowave-config-panel",o.className="ontowave-config-panel",o.innerHTML=`
