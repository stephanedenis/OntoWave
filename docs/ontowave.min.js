(c=>{let o={title:"OntoWave Documentation",baseUrl:"/",defaultPage:"index.md",containerId:"ontowave-container",locales:[],fallbackLocale:"en",showGallery:!1,mermaid:{theme:"default",startOnLoad:!0,flowchart:{useMaxWidth:!0},sequence:{useMaxWidth:!0},gantt:{useMaxWidth:!0},journey:{useMaxWidth:!0}},plantuml:{server:"https://www.plantuml.com/plantuml",format:"svg"},prism:{theme:"default",autoload:!0},navigation:{showHome:!0,showBreadcrumb:!0,showToc:!0},ui:{theme:"default",responsive:!0,animations:!0}};class e{constructor(e={}){this.config={...o,...e},this.container=null,this.mermaidLoaded=!1,this.prismLoaded=!1,this.currentPage=null,console.log("🌊 OntoWave initialized with config:",this.config)}getBrowserLocales(){var e=[];return navigator.languages&&e.push(...navigator.languages),navigator.language&&e.push(navigator.language),navigator.userLanguage&&e.push(navigator.userLanguage),[...new Set(e)]}resolveLocale(){var e,t,o=this.getBrowserLocales(),i=this.config.locales||[];if(console.log("🌐 Browser locales:",o),console.log("🌐 Supported locales:",i),0===i.length)return null;for(e of o)if(i.includes(e))return console.log("🎯 Exact match found:",e),e;for(t of o){let o=t.split("-")[0];var n=i.find(e=>e.startsWith(o));if(n)return console.log("🎯 Prefix match found:",t,"->",n),n}o=i[0];return console.log("🎯 Using fallback locale:",o),o}generatePageCandidates(e){var o,t=this.resolveLocale(),i=[];return t?(o=e.replace(/\.md$/,""),i.push(o+`.${t}.md`),t.includes("-")&&(t=t.split("-")[0],i.push(o+`.${t}.md`)),i.push(e),console.log("📄 Page candidates for",e,":",i)):i.push(e),i}async init(){try{await this.loadConfigFromScript(),this.injectStyles(),await this.loadMermaid(),await this.loadPrism(),this.createInterface(),this.initializeNavigation(),await this.loadInitialPage(),console.log("✅ OntoWave successfully initialized")}catch(e){console.error("❌ OntoWave initialization failed:",e),this.showError("Erreur d'initialisation OntoWave: "+e.message)}}async loadConfigFromScript(){var e=document.getElementById("ontowave-config");if(e&&"application/json"===e.type)try{var o=JSON.parse(e.textContent);this.config={...this.config,...o},console.log("📄 Configuration loaded from script tag")}catch(e){console.warn("⚠️ Invalid JSON in ontowave-config script tag:",e)}}injectStyles(){var e=document.createElement("style");e.textContent=`
    .ontowave-container {
  ...
  `,document.head.appendChild(e)}async loadMermaid(){return new Promise(e=>{var o;c.mermaid?(this.mermaidLoaded=!0,this.initializeMermaid(),e()):((o=document.createElement("script")).src="https://cdn.jsdelivr.net/npm/mermaid@10/dist/mermaid.min.js",o.onload=()=>{this.mermaidLoaded=!0,this.initializeMermaid(),e()},o.onerror=()=>{console.warn("⚠️ Failed to load Mermaid library"),e()},document.head.appendChild(o))})}initializeMermaid(){c.mermaid&&(c.mermaid.initialize(this.config.mermaid),console.log("🎨 Mermaid initialized"))}async loadPrism(){return new Promise(i=>{if(c.Prism)return this.prismLoaded=!0,console.log("🎨 Prism already loaded"),i();var e=document.createElement("link"),e=(e.rel="stylesheet",e.href="https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism.min.css",document.head.appendChild(e),document.createElement("script"));e.src="https://cdn.jsdelivr.net/npm/prismjs@1.29.0/components/prism-core.min.js",e.onload=()=>{console.log("🎨 Prism core loaded");let e=["markup","css","javascript"],o=0,t=()=>{o++,console.log(`🔤 Essential language loaded: ${o}/`+e.length),o>=e.length&&(c.Prism.languages.markup&&(c.Prism.languages.html=c.Prism.languages.markup,console.log("🔤 HTML alias created from markup")),this.prismLoaded=!0,console.log("✅ Prism ready with essential languages"),i(),["python","java","bash","json","yaml","typescript","php"].forEach(e=>{var o=document.createElement("script");o.src=`https://cdn.jsdelivr.net/npm/prismjs@1.29.0/components/prism-${e}.min.js`,o.onload=()=>{console.log("🔤 Additional Prism language loaded: "+e)},o.onerror=()=>{console.warn("⚠️ Failed to load Prism language: "+e)},document.head.appendChild(o)}))};e.forEach(e=>{var o=document.createElement("script");o.src=`https://cdn.jsdelivr.net/npm/prismjs@1.29.0/components/prism-${e}.min.js`,o.onload=t,o.onerror=()=>{console.warn("⚠️ Failed to load essential Prism language: "+e),t()},document.head.appendChild(o)})},e.onerror=()=>{console.warn("⚠️ Failed to load Prism library"),i()},document.head.appendChild(e)})}createInterface(){this.container=document.getElementById(this.config.containerId),this.container||(this.container=document.createElement("div"),this.container.id=this.config.containerId,document.body.appendChild(this.container)),this.container.className="ontowave-container";var e=this.config.showGallery?'<span class="ontowave-menu-option" onclick="window.location.href=\'gallery.html\'">🎨 Galerie</span>':"";this.container.innerHTML=`
      ...
      `}initializeNavigation(){c.addEventListener("hashchange",()=>{var e=location.hash.replace("#","")||this.config.defaultPage;this.loadPage(e)}),this.createDefaultNavigation(),this.initializeFloatingMenu()}initializeFloatingMenu(){let l=document.getElementById("ontowave-floating-menu");var e=document.getElementById("ontowave-menu-icon");if(l&&e){let t=!1,n=!1,a={x:0,y:0};function o(){!t&&!document.querySelector(".ontowave-config-panel")?l.classList.remove("no-drag"):l.classList.add("no-drag")}c.ontowaveUpdateDragState=o,e.addEventListener("click",e=>{e.stopPropagation(),(t=!t)?l.classList.add("expanded"):l.classList.remove("expanded"),o()}),document.addEventListener("click",e=>{!l.contains(e.target)&&t&&(t=!1,l.classList.remove("expanded"),o())}),l.addEventListener("mousedown",e=>{var o;t||document.querySelector(".ontowave-config-panel")||e.target.closest("a, .ontowave-menu-option")||(n=!0,o=l.getBoundingClientRect(),a.x=e.clientX-o.left,a.y=e.clientY-o.top,l.style.cursor="grabbing",document.body.style.userSelect="none",e.preventDefault(),e.stopPropagation())}),document.addEventListener("mousemove",e=>{var o,t,i;n&&(o=e.clientX-a.x,e=e.clientY-a.y,t=c.innerWidth-l.offsetWidth,i=c.innerHeight-l.offsetHeight,l.style.left=Math.max(0,Math.min(t,o))+"px",l.style.top=Math.max(0,Math.min(i,e))+"px")}),document.addEventListener("mouseup",()=>{n&&(n=!1,l.style.cursor="move",document.body.style.userSelect="")}),l.addEventListener("touchstart",e=>{var o;e.target.closest("a, .ontowave-menu-option")||(e=e.touches[0],o=l.getBoundingClientRect(),a.x=e.clientX-o.left,a.y=e.clientY-o.top,n=!0)}),document.addEventListener("touchmove",e=>{var o,t,i;n&&(e.preventDefault(),o=(e=e.touches[0]).clientX-a.x,e=e.clientY-a.y,t=c.innerWidth-l.offsetWidth,i=c.innerHeight-l.offsetHeight,l.style.left=Math.max(0,Math.min(t,o))+"px",l.style.top=Math.max(0,Math.min(i,e))+"px")}),document.addEventListener("touchend",()=>{n=!1}),o(),this.enhanceMenuOptionClicks()}}enhanceMenuOptionClicks(){var e=document.querySelector('.ontowave-menu-option[onclick*="toggleConfigurationPanel"]');e&&e.addEventListener("click",e=>{e.preventDefault(),e.stopPropagation(),console.log("Configuration button clicked via event listener"),this.toggleConfigurationPanel(e)},{capture:!0})}createDefaultNavigation(){var e=document.getElementById("ontowave-nav-grid");e&&(e.innerHTML=[{href:"index.md",icon:"🏠",label:"Accueil"},{href:"en/index.md",icon:"🇬🇧",label:"English"},{href:"fr/index.md",icon:"🇫🇷",label:"Français"},{href:"demo/mermaid.md",icon:"🧜‍♀️",label:"Démo Mermaid"},{href:"demo/plantuml.md",icon:"🏭",label:"PlantUML"},{href:"demo/advanced-shapes.md",icon:"🎯",label:"Formes Avancées"}].map(e=>`
        <a href="#${e.href}" class="ontowave-nav-item" onclick="window.OntoWave.loadPage('${e.href}')">
          ${e.icon} ${e.label}
        </a>
      `).join(""))}async loadInitialPage(){var o,t=location.hash.replace("#","")||this.config.defaultPage;if("index.md"===t){let e=!1;for(o of this.generatePageCandidates(t))try{if((await fetch(this.config.baseUrl+o,{method:"HEAD"})).ok){await this.loadPage(o),e=!0;break}}catch(e){continue}e||(console.log("📄 No index file found, showing configuration"),this.showConfigurationInterface())}else await this.loadPage(t)}async loadPage(o){var e=document.getElementById("ontowave-content");if(e){console.log("📄 Loading page:",o),this.currentPage=o,location.hash!=="#"+o&&(location.hash="#"+o),this.updateBreadcrumb(o),e.innerHTML='<div class="ontowave-loading">⏳ Chargement de '+o+"...</div>";try{var t=await fetch(this.config.baseUrl+o);if(!t.ok)throw new Error(`HTTP ${t.status}: `+t.statusText);var i=await t.text(),n=(console.log("✅ Content loaded:",i.length,"characters"),await this.renderMarkdown(i));e.innerHTML=n,await this.processDiagrams(e),await this.processPrism(e)}catch(e){console.error("❌ Failed to load page:",e),this.showError(`Impossible de charger ${o}: `+e.message)}}}updateBreadcrumb(e){var o=document.getElementById("ontowave-breadcrumb");if(o&&this.config.navigation.showBreadcrumb){let t=e.split("/"),i=['<a href="#'+this.config.defaultPage+'">🏠 Accueil</a>'],n="";t.forEach((e,o)=>{o===t.length-1?i.push("<span>"+e.replace(".md","")+"</span>"):(n+=(n?"/":"")+e,i.push('<a href="#'+n+'/index.md">'+e+"</a>"))}),o.innerHTML=i.join(" <span>›</span> "),o.style.display="block"}}async renderMarkdown(e){let t=e,l=[];return t=(t=t.replace(/```(\w+)([\s\S]*?)```/g,(e,o,t)=>{var i,n,t=t.trim(),a=`__CODE_BLOCK_${l.length}__`;return"mermaid"===o?(n="mermaid-"+Math.random().toString(36).substr(2,9),l.push(`<div class="ontowave-mermaid">
            <div style="margin-bottom: 8px; font-weight: bold; color: #586069;">🧜‍♀️ Diagramme Mermaid</div>
            <div class="mermaid" id="${n}">${t}</div>
          </div>`)):"plantuml"===o?(n="plantuml-"+Math.random().toString(36).substr(2,9),i=`${this.config.plantuml.server}/${this.config.plantuml.format}/~1`+encodeURIComponent(t),l.push(`<div class="ontowave-plantuml" id="${n}">
...
&lt;/html&gt;</code></pre>
      ...
      `,this.addConfigStyles(),this.populateConfigForm(),this.updateGeneratedCode())}populateConfigForm(){var e=document.getElementById("config-title"),o=document.getElementById("config-defaultPage"),t=document.getElementById("config-locales"),i=document.getElementById("config-showGallery"),n=document.getElementById("config-mermaidTheme");e&&(e.value=this.config.title),o&&(o.value=this.config.defaultPage),t&&(t.value=this.config.locales.join(", ")),i&&(i.checked=this.config.showGallery),n&&(n.value=this.config.mermaid.theme)}addConfigStyles(){var e;document.getElementById("ontowave-config-styles")||((e=document.createElement("style")).id="ontowave-config-styles",e.textContent=`
      ...
      `,document.head.appendChild(e))}updateConfigFromForm(){var e=document.getElementById("config-title").value,o=document.getElementById("config-defaultPage").value,t=document.getElementById("config-locales").value.split(",").map(e=>e.trim()).filter(e=>0<e.length),i=document.getElementById("config-showGallery").checked,n=document.getElementById("config-mermaidTheme").value;this.config.title=e,this.config.defaultPage=o,this.config.locales=t,this.config.showGallery=i,this.config.mermaid.theme=n,console.log("📝 Configuration updated:",this.config),document.title=this.config.title,this.updateGeneratedCode(),this.showNotification("✅ Configuration mise à jour")}updateGeneratedCode(){var e={title:this.config.title,baseUrl:this.config.baseUrl,defaultPage:this.config.defaultPage,locales:this.config.locales,fallbackLocale:this.config.fallbackLocale,showGallery:this.config.showGallery,mermaid:{theme:this.config.mermaid.theme}},e=JSON.stringify(e,null,2).replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),e=`&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
    &lt;meta charset="UTF-8"&gt;
    &lt;title&gt;${this.config.title}&lt;/title&gt;
...
${e}
      ...
      `,o.textContent=e,document.getElementById("notification-styles")||((e=document.createElement("style")).id="notification-styles",e.textContent=`
        ...
        `,document.head.appendChild(e)),document.body.appendChild(o),setTimeout(()=>{o.style.animation="slideIn 0.3s ease reverse",setTimeout(()=>{o.parentNode&&o.parentNode.removeChild(o)},300)},3e3)}showError(e){var o=document.getElementById("ontowave-content");o&&(o.innerHTML=`<div class="ontowave-error">❌ ${e}</div>`)}toggleConfigurationPanel(o){o&&(o.preventDefault(),o.stopPropagation());o=document.querySelector(".ontowave-menu-content");if(o){var t=document.querySelector('.ontowave-menu-option[onclick*="toggleConfigurationPanel"]');let e=document.getElementById("ontowave-config-panel");e?(e.remove(),t&&t.classList.remove("selected"),"function"==typeof c.ontowaveUpdateDragState&&c.ontowaveUpdateDragState(),console.log("Config panel closed")):(t&&t.classList.add("selected"),(e=document.createElement("div")).id="ontowave-config-panel",e.className="ontowave-config-panel",e.innerHTML=`
...
&lt;/html&gt;`,o=document.getElementById("generated-html-mini");o&&(o.innerHTML=e)}addConfigPanelStyles(){var e;document.getElementById("ontowave-config-panel-styles")||((e=document.createElement("style")).id="ontowave-config-panel-styles",e.textContent=`
      ...
      `,document.head.appendChild(e))}navigate(e){this.loadPage(e)}getConfig(){return{...this.config}}updateConfig(e){this.config={...this.config,...e},console.log("📝 Configuration updated")}}document.addEventListener("DOMContentLoaded",()=>{c.OntoWave={instance:new e},c.OntoWave.instance.init()}),c.OntoWaveClass=e})(window);