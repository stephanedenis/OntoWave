 ...
 * UML diagrams rendered through Kroki.io API as inline SVG
 */
test.describe('Demo 01-base: PlantUML via Kroki', () => {
  let consoleErrors = [];
  ...
  test('should load without console errors', async ({ page }) => {
    await page.goto('/demos/01-base/plantuml.html');
  ...
  test('should match visual snapshot', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('01-base-plantuml.png', {
      fullPage: true,
