...
.ontowave-menu-brand{display:none;font-weight:600;font-size:0.9rem;color:#1a1a1a;text-decoration:none;white-space:nowrap}
.ontowave-menu-option{display:none;border:1px solid #d0d7de;border-radius:6px;padding:4px 10px;font-size:0.85rem;cursor:pointer;color:#1a1a1a;text-decoration:none;background:none}
...
#ontowave-floating-menu.expanded .ontowave-menu-brand,
