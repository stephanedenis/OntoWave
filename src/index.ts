...
import type { OntoWavePlugin, PluginContext, PluginManager, ContentRenderer, ExtensionRegistry, ExtensionConfig, I18nConfig, RenderPhase, AppConfig } from './core/types'
