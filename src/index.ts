...
import type { OntoWavePlugin, PluginContext, PluginManager, MarkdownRenderer, ContentRenderer, ExtensionRegistry, ExtensionConfig, I18nConfig, RenderPhase } from './core/types'
